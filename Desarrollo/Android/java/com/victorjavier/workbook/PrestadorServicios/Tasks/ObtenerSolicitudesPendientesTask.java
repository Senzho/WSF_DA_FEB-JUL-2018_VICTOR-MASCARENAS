...
public class ObtenerSolicitudesPendientesTask extends AsyncTask<Void, Void, Boolean> {
    private List<Solicitud> solicitudes;
    private int idPrestador;
    private ListView lista;

    public ObtenerSolicitudesPendientesTask(List<Solicitud> solicitudes, int idPrestador, ListView lista){
    ...
    protected Boolean doInBackground(Void... voids) {
        ...
        try{
            URL url = new URL("http://192.168.44.139:8080/ServiciosWorkbook/webresources/SWSolicitud/pendientes/" + this.idPrestador);
